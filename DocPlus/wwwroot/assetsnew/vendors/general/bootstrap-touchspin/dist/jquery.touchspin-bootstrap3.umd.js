...
var TouchSpinJQueryBootstrap3 = (() => {
  ...
  // ../../../.yarn/__virtual__/@touchspin-renderer-bootstrap3-virtual-7d39aca729/1/packages/renderers/bootstrap3/dist/index.js
  var Bootstrap3Renderer = class extends AbstractRendererSimple_default {
    constructor() {
      super(...arguments);
      this.prefixEl = null;
      this.postfixEl = null;
    ...
    buildBasicInputGroup() {
      ...
      if (this.settings.verticalbuttons) {
        ...
        const prefixEl = wrapper.querySelector('[data-touchspin-injected="prefix"]');
        const _postfixEl = wrapper.querySelector('[data-touchspin-injected="postfix"]');
        if (prefixEl) {
          wrapper.insertBefore(this.input, prefixEl.nextSibling);
        } else {
    ...
    buildAdvancedInputGroup(existingInputGroup) {
      ...
      if (this.settings.verticalbuttons) {
        ...
        const downButtonWrapper = tempDiv.querySelector(
          '[data-touchspin-injected="down-wrapper"]'
        );
        ...
        const upButtonWrapper = tempDiv.querySelector(
  ...
  var Bootstrap3Renderer_default = Bootstrap3Renderer;

  // ../standalone/dist/bootstrap3.js
  function mount2(host, opts) {
    return mount(host, opts, Bootstrap3Renderer_default);
  }
...
//# sourceMappingURL=bootstrap3.global.js.map