...
var TouchSpinJQueryVanilla = (() => {
  ...
  // ../../renderers/vanilla/dist/index.js
  var VanillaRenderer = class extends AbstractRendererSimple_default {
    constructor() {
      super(...arguments);
      this.prefixEl = null;
      this.postfixEl = null;
    ...
    hideEmptyPrefixPostfix(wrapper = this.wrapper) {
      const prefixEl = this.prefixEl || (wrapper == null ? void 0 : wrapper.querySelector('[data-touchspin-injected="prefix"]'));
      const postfixEl = this.postfixEl || (wrapper == null ? void 0 : wrapper.querySelector('[data-touchspin-injected="postfix"]'));
  ...
  // ../standalone/dist/chunk-RMEJ4KJB.js
  function mount2(host, opts) {
    return mount(host, opts, VanillaRenderer_default);
  }
...
//# sourceMappingURL=vanilla.global.js.map