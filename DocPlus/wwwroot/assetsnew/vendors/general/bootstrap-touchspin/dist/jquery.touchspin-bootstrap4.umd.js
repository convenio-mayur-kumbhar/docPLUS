...
var TouchSpinJQueryBootstrap4 = (() => {
  ...
  // ../../../.yarn/__virtual__/@touchspin-renderer-bootstrap4-virtual-a0304167f2/1/packages/renderers/bootstrap4/dist/index.js
  var Bootstrap4Renderer = class extends AbstractRendererSimple_default {
    constructor() {
      super(...arguments);
      this.prefixEl = null;
      this.postfixEl = null;
      this.initialInputGroup = null;
    }
    init() {
      this.prefixEl = null;
      this.postfixEl = null;
      this.initialInputGroup = this.input.closest(".input-group");
    ...
    buildInputGroup() {
      const closestGroup = this.input.closest(".input-group");
    ...
    buildBasicInputGroup() {
      ...
      if (this.settings.verticalbuttons) {
        const prefixWrapper = wrapper.querySelector(
          '[data-touchspin-injected="prefix"]'
        );
        const postfixWrapper = wrapper.querySelector(
        ...
        const appendWrapper = wrapper.querySelector(
    ...
    buildAdvancedInputGroup(existingInputGroup) {
      ...
      if (this.settings.verticalbuttons) {
        ...
        const verticalButtonWrapper = tempDiv.querySelector(
          '[data-touchspin-injected="vertical-wrapper"]'
        );
  ...
  // ../standalone/dist/bootstrap4.js
  function mount2(host, opts) {
    return mount(host, opts, Bootstrap4Renderer_default);
  }
...
//# sourceMappingURL=bootstrap4.global.js.map