...
function removeUtilElements(body) {
  var _zeroElement;
  if (zeroElement && ((_zeroElement = zeroElement) == null ? void 0 : _zeroElement.parentNode) === body) {
...
(function () {
  ...
  if (typeof window !== 'undefined' && !isUndefined(window.addEventListener)) {
    ['resize', 'scroll', 'touchmove'].forEach(function (event) {
      window.addEventListener(event, _tick);
    });
  }
})();
  ...
  _proto.move = function move(pos) {
    ...
    if ((same.page.top || same.page.bottom) && (same.page.left || same.page.right)) {
      ...
      if (getOffsetParent(this.element) !== offsetParent) {
        defer(function () {
          var _this8$element;
          (_this8$element = _this8.element) == null || (_this8$element = _this8$element.parentNode) == null || _this8$element.removeChild(_this8.element);
    ...
    if (!moved) {
      if (this.options.bodyElement) {
        ...
        if (!offsetParentIsBody) {
          var _this$element;
          (_this$element = this.element) == null || (_this$element = _this$element.parentNode) == null || _this$element.removeChild(this.element);
...
Tether.modules.push({
  ...
  destroy: function destroy() {
    var _this1 = this;
    ['target', 'element'].forEach(function (type) {
      if (!_this1.markers || !_this1.markers[type]) {
        return;
      }
      var el = _this1.markers[type].el;
      try {
        var _el$parentNode;
        el == null || (_el$parentNode = el.parentNode) == null || _el$parentNode.removeChild(el);
      } catch (e) {
